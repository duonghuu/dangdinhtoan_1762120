<div class="box_container">
	<div class="page-maintitle"><?=_giohang?></div>
                        ...
                        <td width="15%"><img class="img_gh" src="<?=_upload_sanpham_l.$pphoto?>" alt="<?=$pname?>"/></td>
                          <td width="25%"><?=$pname?>
                              <p class="d-flex justify-content-center"> 
                                <?php if(!empty($size)){ ?>Size: <strong class="ml-1"><?= l_ten($size) ?></strong><?php } ?> 
                                <?php if(!empty($mausac)){ ?>- Màu <span class="mau ml-1" style="background: <?= $mausac ?>"></span><?php } ?></p>

                          </td>
                          <td width="15%"><?=number_format(get_price($pid,$size),0, ',', '.')?> đ</td>
                          <td width="10%"><input class="sl_gh" type="number" value="<?=$q?>" maxlength="5" size="2" min="1" max="999" /></td>
                          <td width="15%" class="gia_gh"><?=number_format(get_price($pid,$size)*$q,0, ',', '.') ?> đ</td>
                        </tr>
                  <?php } ?>
                    <?php /* 
                    <tr>
